...
# Modified: removed src.custom dependency, USERAGENT passed as parameter
...
class ABogus:
    ...
    def __init__(self, user_agent: str = _DEFAULT_UA, platform: str = None):
        self.chunk = []
        self.size = 0
        self.reg = self.__reg[:]
    ...
    def generate_browser_info(cls, platform: str = "Win32") -> str:
        ...
        return "|".join(str(x) for x in [iw,ih,ow,oh,0,choice((0,30)),0,0,ow,oh,ow,oh,iw,ih,24,24,platform])
